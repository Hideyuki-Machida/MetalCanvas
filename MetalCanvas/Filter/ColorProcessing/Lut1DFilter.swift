...
extension MCFilter.ColorProcessing {
	public struct Lut1DFilter {
		...
		public init () {
			...
			let vertexFunction: MTLFunction = MCFunction.ColorProcessing.lut1D.vertex
			let fragmentFunction: MTLFunction = MCFunction.ColorProcessing.lut1D.fragment
