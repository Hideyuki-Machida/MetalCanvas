...
class DrawSample02VC: UIViewController {
	...
	/////////////////////////////////////////////////////////////////////////////////////
	struct Dot {
		var position: MCGeom.Vec3D
		var velocity: MCGeom.Vec3D
		var color: MCColor
		var size: Float
		...
		init(position: MCGeom.Vec3D, velocity: MCGeom.Vec3D, color: MCColor, size: Float, renderSize: CGSize) {
	...
	override func viewDidLoad() {
		...
		for _:Int in 0..<self.len {
			let p: MCGeom.Vec3D = MCGeom.Vec3D.init(Float.random(in: 0...Float( self.renderSize.width )), Float.random(in: 0...Float( self.renderSize.height )), 0.0)
			let v: MCGeom.Vec3D = MCGeom.Vec3D.init(Float.random(in: 0...20) - 10, Float.random(in: 0...20) - 10, 0.0)
