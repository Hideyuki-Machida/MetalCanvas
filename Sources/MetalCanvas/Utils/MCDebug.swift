...
extension MCDebug {
    public static func threadCount() -> UInt32 {
        return UInt32(MemoryLayout<mach_task_basic_info_data_t>.size / MemoryLayout<natural_t>.size)
    }
    ...
    public static func usedCPU() -> Float {
        ...
        var threadCount = MCDebug.threadCount()
